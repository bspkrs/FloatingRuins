...
{
    public final static String versionNumber        = "1.4.6.r01";
    ...
    public static String       spawnerForest        = "Wolf, CaveSpider";
    ...
    public static String       spawnerSwampland     = "Slime, Creeper, CaveSpider, Witch";
