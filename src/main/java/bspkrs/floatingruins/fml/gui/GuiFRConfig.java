...
public class GuiFRConfig extends GuiConfig
{
    ...
    {
        super(parent, getProps(), Configuration.class.getDeclaredMethod("save"), FloatingRuins.getConfig(),
                FloatingRuins.class.getDeclaredMethod("syncConfig"), null);
    }
    
    public GuiFRConfig(GuiScreen par1GuiScreen, IConfigProperty[] properties, Method saveAction, Object configObject, Method afterSaveAction, Object afterSaveObject)
    {
    ...
    {
        ConfigCategory cc = FloatingRuins.getConfig().getCategory(Configuration.CATEGORY_GENERAL);
